...
import org.cresplanex.core.common.kafka.baskpressure.BackPressureActions;
import org.cresplanex.core.common.kafka.baskpressure.BackPressureConfig;
import org.cresplanex.core.common.kafka.baskpressure.BackPressureManager;
import org.cresplanex.core.common.kafka.lower.KafkaConsumerFactory;
import org.cresplanex.core.common.kafka.lower.KafkaMessageConsumer;
import org.cresplanex.core.common.kafka.property.ConsumerPropertiesFactory;
...
public class CoreKafkaConsumer {
     ...
     * @param coreKafkaConsumerProperties コンシューマーの設定プロパティ
    ...
    public CoreKafkaConsumer(String subscriberId,
        ...
        this.consumerProperties.putAll(coreKafkaConsumerProperties.getProperties());
        this.backPressureConfig = coreKafkaConsumerProperties.getBackPressure();
    }
